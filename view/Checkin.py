...
class Checkin:
    """Checkin view class with TKinter
    """
    ...
    def __init__(self) -> None:
        ...
        self.lastLabel = tk.Label(
            self.mainWindow, text="LastName", font="none 20 bold")
        ...
        self.roomLabel = tk.Label(
            self.mainWindow, text="Room", font="none 20 bold")
