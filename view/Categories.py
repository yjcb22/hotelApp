...
class Categories:
    def __init__(self, master = None) -> None:
        ...
        self.activeLabel = tk.Label(self.mainWindow, text="Active", font="none 20 bold")
        ...
        self.treeTable.insert(parent='', index="end", iid=0, text="1", values=("test", "test"))
        self.treeTable.insert(parent='', index="end", iid=1, text="2", values=("test", "test"))
