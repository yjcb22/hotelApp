...
class Categories:
    def __init__(self) -> None:
        ...
        self.editBtn.grid(row=1, column=3)
        
        self.deleteBtn = tk.Button(self.mainWindow, text="Delete", width=10)
        self.deleteBtn.grid(row=1, column=4)
        ...
        self.hintLabel.grid(row=2, column=0, columnspan=6)
        ...
        self.treeTable.grid(row=3, column=0, columnspan=6)