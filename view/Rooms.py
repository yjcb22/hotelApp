...
class Rooms(tk.Tk):
    ...
    def __init__(self, master=None) -> None:
        ...
        self.id_label = tk.Label(self.main_window, text="ID", font="none 20 bold")
        ...
        self.addr_label = tk.Label(self.main_window, text="Address", font="none 20 bold")
        ...
        self.desc_label = tk.Label(self.main_window, text="Description", font="none 20 bold")
        ...
        self.size_label = tk.Label(self.main_window, text="Size", font="none 20 bold")
        ...
        self.name_label = tk.Label(self.main_window, text="Name", font="none 20 bold")
        ...
        self.cat_label = tk.Label(self.main_window, text="Category", font="none 20 bold")
        ...
        self.act_label = tk.Label(self.main_window, text="Active", font="none 20 bold")
        ...
        self.hint_label = tk.Label(self.main_window, text="Hint: Click then edit or delete", font="none 20")
        self.hint_label.grid(row=4, column=0, columnspan=10)
            
        self.tree_table = ttk.Treeview(self.main_window)
        self.tree_table['columns'] = ('Address', 'Description', 'Size', 'Name', 'Category', 'Active')
        ...
        self.tree_table.heading("Description", text="Description", anchor="center")
        ...
        self.tree_table.insert(parent='', index="end", iid=0, text="1", values=("test", "test", "test"))
        self.tree_table.insert(parent='', index="end", iid=1, text="2", values=("test", "test", "test"))
