...
class RoomDAO:
    ...
    def __init__(self, db) -> None:
        ...
        self.SQL_INSERT = "INSERT INTO Rooms (address, description, size, name, active, id_category) \
        VALUES (%s, %s, %s, %s, %s, %s)"
...
###SELECT####
    ...
    def select_all_rooms(self) -> list[RoomDTO]:
...
##INSERT###
    ...
    def insert_room(self, room: RoomDTO) -> None:
        ...
        """
        cur = self.db.cx.cursor()
        cur.execute(self.SQL_INSERT, (room.address, room.description,
                    room.size, room.name, room.active, room.category))
        self.db.cx.commit()
...
# UPDATE
    def update_room(self, room: RoomDTO) -> None:
